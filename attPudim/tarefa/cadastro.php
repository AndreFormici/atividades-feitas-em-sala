...
<html>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" action="lista.php" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <div class="custom-file">
                          <input type="file" class="custom-file-input" name="imagemUpload" value="Procurar..." accept="image/png, image/jpg" id="exampleInputFile">
  ...
  <form >
    ...
    <input type="file" name="imagemUpload" value="Procurar..." accept="image/png, imagem/jpg">
